...
let codeSearchHeight = $device.info.screen.height - (($app.env == $env.app) ? 545 : 570);
let codeContentHeight = $context.dataItems ? 400 : $device.info.screen.height - (($app.env == $env.app) ? 120 : 170);
...
function show(textContent, popItems = []) {
  if (!textContent) {
    naviaddButton = {
      title: "Add",
      icon: "104",
